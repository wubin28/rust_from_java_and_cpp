...
hidden if the `ownership_story_cpp_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `ownership_story_cpp_DEVELOPER_MODE` to the configure
...
Runs the executable target `ownership_story_cpp_exe`.
